...
(this will terminate the print)."))
    ...
    def do_3dpavinit_final(self):
      ...
      self.log(_(";factory reset"))
      self.p.send_now("G21")
      self.log(_(";metric values"))
      self.p.send_now("G90")
      self.log(_(";ABSOLUTE positioning"))
      self.p.send_now("M83") 
      self.log(_(";RELATIVE POSITIONING ONLY FOR E"))
      self.p.send_now("M107") 
      self.log(_(";start with the fan off"))
      self.p.send_now("M203 Z800 E800")
      self.log(_(";Z1 AND Z2 MAX FEEDRATE"))
      self.p.send_now("M201 Z100 E100")
      self.log(_(";Z1 AND Z2 MAX ACCEL [110 WORKS AND 130 MAKES IT FAIL]"))
      self.p.send_now("M205 Z000.40 E000.40")
      self.log(_(";SET Z1 AND Z2 JERK"))
      self.p.send_now("M92 Z400 E400")
      self.log(_(";SET Z1 AND Z2 ESTEPS"))
      self.p.send_now("M302 S0") 
      self.log(_(";ALLOW EXTRUDER TO COLD EXTRUDE"))
      self.p.send_now("M18 E") 
      self.log(_(";DISABLE Z2 FOR HOMING"))
      self.p.send_now("M0 CHK NO BUNGEE+ Y BACK")
      self.log(_(";NO BUNGEE+ Y BACK"))
      self.p.send_now("G28 Z") 
      self.log(_(";home z"))
      self.p.send_now("M17 E")
      self.log(_(";ENABLE Z2 AGAIN"))
      self.p.send_now("G92 E0")
      self.log(_(";define Z2 position as zero"))
      self.p.send_now("G1 F500 Z5") 
      self.log(_(";ADDING 5 MM TO Z1 TO CORRECT FOR HOMING DRAG"))
      self.p.send_now("G1 F2000 Z130 E-125")
      self.log(_(";move z1 and z2 together to decompress position"))
      self.p.send_now("G28 Y") 
      self.log(_(";home y"))
      self.p.send_now("G1 F2000 Y150")
      self.log(_(";move y to decompress position"))
      self.p.send_now("M0 ADD BUNGEE TO CONT.")
