...
(this will terminate the print)."))
    ...
    def do_print(self, l):
        self.fgcode = "G1 F2500 Z116 Y100 E14 \n G1 F1250 Z130 Y145 E-14"
        print('self.fgcode: ', self.fgcode)
        if not self.fgcode:
